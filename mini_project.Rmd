...
Par suite, le schéma 2 décentré est consistant.
...
Ainsi, le schéma 2 décentré est stable si $\frac{a\Delta t}{\Delta x} \leq 1$.

    - **Convergence**

Le schema 2 décentré etant consistant et conditionnellement stable; en utilisant le theorème de Lax sous les memes conditions de stabilité, on deduit que le schema 2 décentré en amont est convergent lorsque $a>0$.
