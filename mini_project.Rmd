...
$$
\begin{aligned}
\frac{u_{j}^{n+1}-u_{j}^{n}}{\Delta t} + a\frac{u_{j+1}^{n}-u_{j-1}^{n}}{2\Delta x} - \frac{a^{2}\Delta t}{2(\Delta x)^{2}}(u_{j-1}^{n}-2u_{j}^{n}+u_{j+1}^{n}) = 0 & \implies \frac{C^{n+1}e^{i\xi x_{j}}-C^{n}e^{i\xi x_{j}}}{\Delta t} + a\frac{C^{n}e^{i\xi x_{j+1}}-C^{n}e^{i\xi x_{j-1}}}{2\Delta x} - \frac{a^{2}\Delta t}{2(\Delta x)^{2}}(C^{n}e^{i\xi x_{j-1}}-2C^{n}e^{i\xi x_{j}}+C^{n}e^{i\xi x_{j+1}}) = 0\\
       & \implies \frac{C^{n+1}e^{i\xi j\Delta x}-C^{n}e^{i\xi j\Delta x}}{\Delta t} + a\frac{e^{i\xi \Delta x}-e^{-i\xi \Delta x}}{2\Delta x}e^{i\xi j\Delta x}C^{n} - \frac{a^{2}\Delta t}{2(\Delta x)^{2}}(e^{-i\xi \Delta x}-2+e^{i\xi \Delta x})e^{i\xi j\Delta x}C^{n} = 0\\
       & \implies \frac{C^{n+1}-C^{n}}{\Delta t}e^{i\xi j\Delta x} + a\frac{e^{i\xi \Delta x}-e^{-i\xi \Delta x}}{2\Delta x}C^{n}e^{i\xi j\Delta x} - \frac{a^{2}\Delta t}{2(\Delta x)^{2}}(e^{-i\xi \Delta x}-2+e^{i\xi \Delta x})C^{n}e^{i\xi j\Delta x} = 0\\
       & \implies C^{n+1} = C^{n} - \frac{a\Delta t}{\Delta x}(isin(\xi \Delta x))C^{n} + \frac{a^{2}(\Delta t)^2}{(\Delta x)^{2}}(cos(\xi \Delta x)-1)C^{n}\\
       & \implies C^{n+1} = (1 - i\lambda sin(\xi \Delta x) + \lambda^2(cos(\xi \Delta x)-1))C^{n}, \text{ avec } \lambda = \frac{a\Delta t}{\Delta x}\\
\end{aligned}
$$
