...
errors = pd.Series([L1_centre, L1_decentre_amont, L1_decentre_aval, L1_Lax_Friedrichs, L1_Lax_Wendroff], index=['Centre', 'Decentre Amont', 'Decentre Aval', 'Lax-Friedrichs', 'Lax-Wendroff'])
...
On remarque que le schema numerique decentre en aval est celui qui a la plus grande erreur en norme $L^1$, suivi du schema numerique centre. Les schemas numeriques decentre en amont et Lax-Wendroff ont des erreurs en norme $L^1$ les plus faibles.
